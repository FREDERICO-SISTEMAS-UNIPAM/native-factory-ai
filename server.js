...
const AUTH_DIR = process.env.WA_AUTH_DIR || path.join(__dirname, 'data', 'auth_info_baileys');
            ...
            if (pres.lastKnownPresence === 'composing' || pres.lastKnownPresence === 'recording') {
                ...
                if (matchingStore) {
                    ...
                    if (distKm <= matchingStore.maxRadiusKm) {
                        ...
                        console.log(`[RADAR 🛡️ IGNORADO] ${matchingStore.name} digitando a ${formattedDist} km (Fora do limite).`);
                        broadcastToClients({
                            type: 'log_event',
...
// ROUTING: Servir radar.html nas rotas / e /radar
